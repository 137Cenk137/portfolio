...
import foxs_islands from '../assets/3d/foxs_islands.glb'
...
export function Island({ isRotating, setIsRotating, setCurrentStage, ...props }) {
  ...
  const { nodes, materials } = useGLTF(foxs_islands) 
...
useFrame(() => {
    if(!isRotating){
      rotationSpeed.current *= dampingRatio;
      ...
      switch (true) {
        ...
        setCurrentStage (3); break;
         case normalizedRotation >= 2.4 && normalizedRotation <= 2.6:
        setCurrentStage (2); break;
  ...
  }, [gl, handlePointerDown, handlePointerUp, handlePointerMove, keyDownHandler, keyUpHandler])
  return (
